    ...
    connect() {
        ...
        new TsSelect2(this.element, {
            ...
            templateResult: function (visibility) {
                ...
                return self.htmlToElement(
                    '<div>' + self.getIcon(visibility.element.value) + '<span>' + visibility.text + '</span><span class="select-tip">' + Translator.trans('global.visibilities.' + visibility.id + '.field-description') + '</span></div>'
                );
            },
        })
    }
